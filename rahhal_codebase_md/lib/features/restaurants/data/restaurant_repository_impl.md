# ملف كود Dart: lib\features\restaurants\data\restaurant_repository_impl.dart
...
class RestaurantRepositoryImpl implements RestaurantRepository {
  ...
  Future<Either<Failure, RestaurantEntity>> getRestaurantById(
    ...
    try {
      ...
      if (row == null) {
        return Left(DatabaseFailure(AppStrings.languageCode == 'ar' ? 'المطعم غير موجود' : 'Restaurant not found'));
      }
