# ملف كود Dart: lib\features\map\presentation\widgets\map_tab.dart
...
class _MapViewState extends State<_MapView> {
  ...
  LatLng _center() {
    if (widget.state.filteredStops.isEmpty) {
      return const LatLng(41.0, 29.0); // Istanbul default
    }
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(stop.durationLabel, style: AppTextStyles.labelSmall),
                const SizedBox(width: 8),
                Text(stop.costLabel,
                    style: AppTextStyles.labelSmall.copyWith(
                      color: AppColors.accentAmber,
