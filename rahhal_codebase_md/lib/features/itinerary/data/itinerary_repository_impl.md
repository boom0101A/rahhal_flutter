# ملف كود Dart: lib\features\itinerary\data\itinerary_repository_impl.dart
...
class ItineraryRepositoryImpl implements ItineraryRepository {
  ...
  Future<Either<Failure, StopEntity>> getStopById(String stopId) async {
    try {
      ...
      if (row == null) {
        return Left(DatabaseFailure(AppStrings.languageCode == 'ar' ? 'المحطة غير موجودة' : 'Stop not found'));
      }
