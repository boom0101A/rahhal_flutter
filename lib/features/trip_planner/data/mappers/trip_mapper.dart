...
class TripMapper {
  static TripEntity fromMap(Map<String, dynamic> m) => TripEntity(
        ...
        aiSummaryEn: m['ai_summary_en'] as String?,
        travelTipsEn: _decodeList(m['travel_tips_en'] as String?),
        bestTimeToVisitEn: m['best_time_to_visit_en'] as String?,
  ...
  static Map<String, dynamic> toMap(TripEntity t) => {
        ...
        'ai_summary_en': t.aiSummaryEn,
        'travel_tips_en': jsonEncode(t.travelTipsEn),
        'best_time_to_visit_en': t.bestTimeToVisitEn,
        'currency': t.currency,
        'timezone': t.timezone,
